              ...
              <div className="card col-4 cardmin">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    romp thru the world`&lsquo`s most misunderstood programming
                    language, Crockford reveals what is actually going on, and
                    how we can use this to write better programs. `&lsquo`
                  </p>
                </div>
              </div>
              ...
              <div className="card col-4 cardmin">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    technical talk covering data structures and algorithms.`&lsquo`
                  </p>
                </div>
              </div>
            </div>
